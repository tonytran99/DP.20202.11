...
public interface InterbankInterface {
	 ...
	 */
	public abstract PaymentTransaction payOrder(CardStrategy cardStrategy , int amount, String contents)
	 ...
	 *                               something goes wrong
	 */
	public abstract PaymentTransaction refund(CardStrategy cardStrategy, int amount, String contents)
			throws PaymentException, UnrecognizedException;
